...
public class ReservationDAO {
	...
	public String cancelR(String id)throws AppException {
		Connection con = DBUtil.connect();
		PreparedStatement ps1 = null;
		PreparedStatement ps = null;
		ResultSet rs1 = null;	
		...
		try {
			...
			if(rs1.next()){
				ps = con.prepareStatement("UPDATE fonduefun_reservation_system.reservations SET Reservation_Status='Cancelled'"
						+ " WHERE Reservation_ID=?");

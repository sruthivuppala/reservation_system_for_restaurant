...
public class CompleteDataDAO {
	...
	public CompleteData create(CompleteData completeData)throws AppException {
		...
		try {
			...
			String reservation_date =completeData.getReservation_Date();
			reservation_date = reservation_date.substring(0,9); 
			
			ps2.setString(1,reservation_date);
			...
			if(rs4.next()){
				...
				completeData.setReservation_Status(rs4.getString("Reservation_Status"));
			}
